...
# Ejecutar seed al inicio del contenedor (no durante build)
CMD python seed_data.py && gunicorn --bind 0.0.0.0:4010 --workers 2 --timeout 60 --access-logfile - --error-logfile - app:app
